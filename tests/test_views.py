...
class TestFigure(unittest.TestCase):
    ...
    def test_letter_change_number_change_letter(self):
        ...
        test_number_change_letter = test_change.number_change_letter([test_letter_change_number])
    ...
    def test_moves_rook(self):
        ...
        self.assertEqual(list_rook_moves, ['a2', 'a3', 'a4', 'a5', 'a6', 'a7', 'a8', 'b1', 'c1', 'd1', 'e1', 'f1', 'g1', 'h1'])
    ...
    def test_list_available_moves(self):
        ...
        self.assertEqual(list_king_moves ,['c5', 'e5', 'e3', 'c3', 'c4', 'd3', 'e4', 'd5'])
